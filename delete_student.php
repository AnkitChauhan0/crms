<html>
    ...
    echo '<script type="text/javascript">alert("' . $msg . '")</script>';
			...
			if($_SERVER["REQUEST_METHOD"]=="POST"){
					$uname = $_POST['uname'];
					$pwd = $_POST['pwd'];
					$sql1="SELECT pwd from student where email=\"" . $uname . "\"";
	...
	<div class="container-fluid text-center form-box" style="height: 130px;width: 450px;" id="frm1">
		<form action="" method="POST">
			<div>
				<label for="usrnm" style="color: white;"><b>Enter Username</b></label>
				<input type="text" placeholder="Enter Username" name="uname" id="usrnm" required>
			</div><br>
			<div>
				<label for="pswrd" style="color: white;"><b>Enter Password</b></label>
